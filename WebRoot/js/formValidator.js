	...
	showAjaxMessage : function(returnObj)
	{
		...
		else
		{
			...
			if(setting.isvalid!=undefined && !setting.isvalid){
				////alert("eeeeee,validating");
				//elem.lastshowclass = "onError"; 
				//elem.lastshowmsg = setting.onerror;
				
				elem.lastshowclass = "onWait"; 
				elem.lastshowmsg = setting.onwait;
...
$.fn.formValidator = function(cs) 
{
	var setting = 
	{
		...
		submitonce : false,
		automodify : false,
		onshow :"Input Something",
		onfocus: "Input Something",
		oncorrect: "Right Input",
		onempty: "Empty Input",
		defaultvalue : null,
		bind : true,
		...
		if(srcTag == "input" || srcTag=="textarea")
		{
			...
			{	
				...
				if (stype == "password" || stype == "text" || stype == "textarea" || stype == "file") {
					//alert(this.validoldvalue+"|"+jqobj.val());
...
$.fn.ajaxValidator = function(controlOptions)
{
	var settings = 
	{
		...
		error : function(){},
		buttons : null,
		onerror:"Server Validate Fail",
		onwait:"Waiting Server",
